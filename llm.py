...
class LLM():
    ...
    def process_response(self, user_input: str, message: dict, function_name: str, function_response: str) -> str:
        """
        Process the response from the LLM after a function has been called.

        Args:
            user_input (str): The original text from the user.
            message (dict): The message from the LLM.
            function_name (str): The name of the function that was called.
            function_response (str): The response from the function.
